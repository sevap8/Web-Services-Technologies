...
public class PostgreSQLDAO {
    ...
    public List<Person> findPersons(String id, String name, String surname,
    ...
    public int createPerson(Person person) throws InsertingException {
    ...
    public int updatePerson(int id, Person person) throws
    ...
    private String createUpdateQuery(Person person) {
