...
public class App {
    ...
    public static void main(String args[]) {
        ...
        String wsdl = "http://localhost:8081/PersonService?wsdl";
        String businessKey = "uddi:localhost:0174084d-cbf1-44f2-af31-1b3c3ca7087d";
        String serviceName = "PersonWebService";
        String serviceDescription = "Simple service for getting information about persons";
        String serviceKey = "";
        ...
        if (client != null) {
            ...
            try {
                ...
                System.out.println("Publish service " + serviceName + " with"
                        + "access point " + wsdl);
                serviceKey = juddi.publish(serviceName, serviceDescription, wsdl);
                     ...
                     System.out.println();System.out.println("Find service by service name = " + serviceName);
